...
class UpdateUserDetail extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            telnum: this.props.data.contact,
            photo: '',
            touched: {
                username: false,
                telnum: false,
    ...
    handleLogin(event) {
        ...
        const options = {
            ...
            body:JSON.stringify({'old':this.props.data.contact,'user':this.state.username,'contactnum':this.state.telnum,'photo':this.state.photo==''?this.props.data.photo:this.state.photo})
        };
       const a=this.state.username;
       const b=this.state.telnum;
       const c=this.state.photo;
       console.log(a,b,c);
        fetch(url,options)
            .then(response => {
             return response.json();
                ...
                this.props.handleupdate(this.props.data,a,b,c);
                else
                alert(data.Status);
            });
